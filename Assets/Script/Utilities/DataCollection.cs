...
[System.Serializable]
public class SceneItemCollection
{
    public string CollectionName;
    public int siblingNum;
    public List<int> collectionitemIDList;
}
...
public class NPCDetails
{
    ...
    //这个npc出现过了没有
    public bool isThisAppear;

    //动画用
    public float leftpx;  //不需要左右移动的npc 都填0 需要左右移动的npc left和right更具NPCposition写相应的左右移动范围
    public float rightpx;
    public float speed;
    public bool UnNeedAnim;
...
[System.Serializable]
public class ChurchBedDetails
{
    public bool[] isLianOpen;
    public bool[] isLyingPeople;
}
